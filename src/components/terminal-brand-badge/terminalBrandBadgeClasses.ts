...
export const TERMINAL_BRAND_BADGE_HEIGHT_PX = 52;

export const terminalBrandBadgeRootClass =
  'relative h-[52px] max-h-[52px] w-full max-w-[157px] shrink-0 overflow-clip rounded-[10px]';
...
export const terminalBrandBadgeModuleClass = cn(
  'terminal-dashboard-brand-badge relative h-[52px] w-full max-w-[157px] shrink-0 overflow-visible',
);

/** Fixed header slot — badge keeps its pixel size beside the nav module. */
export const terminalBrandBadgeSlotClass =
  'terminal-dashboard-brand-badge-slot h-[52px] w-full max-w-[157px] shrink-0 overflow-visible';
