...
export const TERMINAL_BRAND_BADGE_HEIGHT_PX = 51;

export const terminalBrandBadgeRootClass =
  'relative h-[51px] max-h-[51px] w-full max-w-[157px] shrink-0 overflow-clip rounded-[10px]';
...
export const terminalBrandBadgeSlotClass =
  'terminal-dashboard-brand-badge-slot h-[51px] w-full max-w-[157px] shrink-0 overflow-visible';
